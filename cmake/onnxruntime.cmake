...
if(CMAKE_SYSTEM_NAME STREQUAL "Android" AND onnxruntime_MINIMAL_BUILD)
  ...
  # creating the DSO our dummy __cxa_demangle always comes before libc++abi.a so the __cxa_demangle
  # in libc++abi.a is discarded, thus, huge binary size reduction.
